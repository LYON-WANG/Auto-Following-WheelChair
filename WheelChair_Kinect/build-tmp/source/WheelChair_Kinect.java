  ...
  if(Mode_Flag == 1)
  {
    ...
    if (userList.size()>0)
    {
      ...
      if (kinect.isTrackingSkeleton(userID))
      {
        ...
        offset = PApplet.parseInt(map(torsoPosition.x, -700, 700, -13,13));    //Offset 
        SpeedFollowing = PApplet.parseInt(map(torsoPosition.z, 1700, 3000, 15, 90));   //Speed with Distance
